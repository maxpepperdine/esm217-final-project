...
###### Select relevant facilities and county by county 

```{r}
# select only the facilities we're interested in
...
health_facilities_county <- health_facilities %>%
  ...
  rename(name = County) # rename for later joining with the PM2.5/asthma data
...
```{r}
# join the health facilities data to the PM2.5/asthma data by county name
...
#### PM2.5 and asthma data by county for fire season months
